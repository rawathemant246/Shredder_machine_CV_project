...
def drawboxtosafeline(image_np,p1,p2,Line_Position2,Orientation):
    ...
    if (distance_from_line <= 0) :
        ...
        #sound = os.path.join()
        #playsound("/home/deepu/anaconda3/Ineuron_Project/DL/shredder-machine/utils/alert.wav")
        wave_obj = sa.WaveObject.from_wave_file("/home/deepu/anaconda3/Ineuron_Project/DL/shredder-machine/utils/alert.wav")
